    ...
    <div class="flex">
        <div id="Left-Content" class="flex flex-col gap-[30px] w-[470px] shrink-0">
            <a href="choose-tiers.html"
                ...
                <img src="{{ asset('images/icons/arrow-left-white.svg') }}" class="w-6 h-6" alt="icon">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex flex-col gap-[2px] items-center justify-center">
                                        ...
                                        @else
                                        <class="text-sm text-garuda-grey">Direct</p>
                                            @endif
                                    </div>
                                </div>
        ...
        <div id="Plane" class="relative flex w-[558px] shrink-0 mt-[30px] mx-auto">
            ...
            <div class="relative flex flex-col justify-end">
                ...
                <form action="{{ route('booking.confirmSeat', $flight->flight_number) }}" method="POST"
                    class="relative px-[56px] pb-[60px]">
...
@section('scripts')
<script>
    const basePrice = parseInt('@json($tier->price)');
</script>
