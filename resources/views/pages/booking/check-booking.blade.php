...
<main class="relative flex flex-col w-full max-w-[1280px] px-[75px] mx-auto mt-[50px] mb-[62px]">
    ...
    <div class="flex gap-[30px] mt-[30px]">
        <form action="{{ route('booking.show') }}" method="POST" class="flex flex-col gap-[30px] w-[490px] shrink-0">
            ...
            @if(session('error'))
                <div class="p-4 rounded-[20px] bg-red-100 text-red-700 font-semibold">
                    {{ session('error') }}
                </div>
            @endif
            ...
            <div id="Booking-details" class="flex flex-col rounded-[20px] p-5 gap-5 bg-white overflow-hidden">
                ...
                <div class="flex flex-col gap-[10px]">
                    ...
                    <div class="flex items-center rounded-full border border-garuda-black py-3 px-5 gap-[10px] focus-within:border-[#0068FF] transition-all duration-300">
                        ...
                        <input type="text" name="booking_trx_id" class="appearance-none outline-none w-full font-semibold placeholder:font-normal" placeholder="Write your booking id" required>
                    </div>
                </div>
                <div class="flex flex-col gap-[10px]">
                    ...
                    <div class="flex items-center rounded-full border border-garuda-black py-3 px-5 gap-[10px] focus-within:border-[#0068FF] transition-all duration-300">
                        ...
                        <input type="tel" name="phone" class="appearance-none outline-none w-full font-semibold placeholder:font-normal" placeholder="Write your phone number" required>
                    </div>
                </div>
                ...
                <p class="mt-5 text-sm text-garuda-grey">Jika anda memiliki masalah dalam pemeriksaan status silahkan menghubungi tim sales kami untuk anda</p>
