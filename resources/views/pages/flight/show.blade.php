...
<main class="relative flex flex-col w-full max-w-[1280px] px-[75px] mx-auto mt-[50px] mb-[62px]">
    ...
    <div class="flex gap-[30px] mt-[30px]">
        ...
        <form action="{{ route('booking',$flight->flight_number) }}" id="Tiers"
            class="grid grid-cols-2 gap-x-[30px]">
            ...
            <div class="flex flex-col h-fit rounded-[20px] p-5 pb-[30px] gap-5 bg-white">
                ...
                <button type="button" onclick="selectClass('{{ $class->id }}')"
...
<script>
    function selectClass(classId) {
        // Set value input hidden dengan ID kelas yang di-klik
        document.getElementById('flight_class_id').value = classId;

        // Kirim (submit) form secara otomatis
        document.getElementById('Tiers').submit();
    }
</script>
@endsection